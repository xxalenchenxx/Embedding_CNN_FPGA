...
################################################################
# This is a generated script based on design: PS_PL_test
#
...
# source PS_PL_test_script.tcl


# The design that will be created by this Tcl script contains the following 
# module references:
# NN_test_IO, myip_v1_0
...
proc create_root_design { parentCell } {
  ...
  # Create instance: NN_test_IO_0, and set properties
  set block_name NN_test_IO
  set block_cell_name NN_test_IO_0
  if { [catch {set NN_test_IO_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_gid_msg -ssname BD::TCL -id 2095 -severity "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $NN_test_IO_0 eq "" } {
  ...
  # Create instance: blk_ram_inimg, and set properties
  set blk_ram_inimg [ create_bd_cell -type ip -vlnv xilinx.com:ip:blk_mem_gen:8.4 blk_ram_inimg ]
  set_property -dict [ list \
   CONFIG.Byte_Size {9} \
  ...
  set_property -dict [ list \
   ...
   CONFIG.PCW_ACT_FPGA0_PERIPHERAL_FREQMHZ {49.500000} \
   CONFIG.PCW_ACT_FPGA1_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA2_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_FPGA3_PERIPHERAL_FREQMHZ {10.000000} \
   CONFIG.PCW_ACT_PCAP_PERIPHERAL_FREQMHZ {198.000000} \
   ...
   CONFIG.PCW_CRYSTAL_PERIPHERAL_FREQMHZ {33} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR0 {13} \
   CONFIG.PCW_DCI_PERIPHERAL_DIVISOR1 {8} \
   CONFIG.PCW_DDRPLL_CTRL_FBDIV {32} \
   CONFIG.PCW_DDR_DDR_PLL_FREQMHZ {1056.000} \
   ...
   CONFIG.PCW_IO_IO_PLL_FREQMHZ {1584.000} \
...
unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned#unassigned} \
  ...
  connect_bd_intf_net -intf_net axi_dma_0_M_AXIS_MM2S [get_bd_intf_pins axi_dma_0/M_AXIS_MM2S] [get_bd_intf_pins myip_v1_0_0/s00_axis]
  ...
  connect_bd_intf_net -intf_net myip_v1_0_0_m00_axis [get_bd_intf_pins axi_dma_0/S_AXIS_S2MM] [get_bd_intf_pins myip_v1_0_0/m00_axis]
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M01_AXI [get_bd_intf_pins myip_v1_0_0/s00_axi] [get_bd_intf_pins ps7_0_axi_periph/M01_AXI]

  # Create port connections
  connect_bd_net -net NN_test_IO_0_NN_out_female [get_bd_pins NN_test_IO_0/NN_out_female] [get_bd_pins myip_v1_0_0/NN_out_female]
  connect_bd_net -net NN_test_IO_0_NN_out_male [get_bd_pins NN_test_IO_0/NN_out_male] [get_bd_pins myip_v1_0_0/NN_out_male]
  connect_bd_net -net NN_test_IO_0_end_NN [get_bd_pins NN_test_IO_0/NN_end] [get_bd_pins myip_v1_0_0/NN_end]
  connect_bd_net -net NN_test_IO_0_renable [get_bd_pins NN_test_IO_0/renable] [get_bd_pins blk_ram_inimg/enb]
  connect_bd_net -net blk_mem_gen_0_doutb [get_bd_pins NN_test_IO_0/rdata] [get_bd_pins blk_ram_inimg/doutb]
  connect_bd_net -net myip_v1_0_0_AXI_BRAM_raddr [get_bd_pins NN_test_IO_0/raddr] [get_bd_pins blk_ram_inimg/addrb]
  connect_bd_net -net myip_v1_0_0_NN_addra [get_bd_pins blk_ram_inimg/addra] [get_bd_pins myip_v1_0_0/NN_addra]
  connect_bd_net -net myip_v1_0_0_NN_dina [get_bd_pins blk_ram_inimg/dina] [get_bd_pins myip_v1_0_0/NN_dina]
  connect_bd_net -net myip_v1_0_0_NN_en [get_bd_pins blk_ram_inimg/ena] [get_bd_pins myip_v1_0_0/NN_en]
  connect_bd_net -net myip_v1_0_0_NN_start [get_bd_pins NN_test_IO_0/NN_start] [get_bd_pins myip_v1_0_0/NN_start]
  connect_bd_net -net myip_v1_0_0_NN_wea [get_bd_pins blk_ram_inimg/wea] [get_bd_pins myip_v1_0_0/NN_wea]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_pins NN_test_IO_0/clk] [get_bd_pins axi_dma_0/m_axi_mm2s_aclk] [get_bd_pins axi_dma_0/m_axi_s2mm_aclk] [get_bd_pins axi_dma_0/s_axi_lite_aclk] [get_bd_pins axi_mem_intercon/ACLK] [get_bd_pins axi_mem_intercon/M00_ACLK] [get_bd_pins axi_mem_intercon/S00_ACLK] [get_bd_pins axi_mem_intercon/S01_ACLK] [get_bd_pins blk_ram_inimg/clka] [get_bd_pins blk_ram_inimg/clkb] [get_bd_pins myip_v1_0_0/clk] [get_bd_pins myip_v1_0_0/m00_axis_aclk] [get_bd_pins myip_v1_0_0/s00_axi_aclk] [get_bd_pins myip_v1_0_0/s00_axis_aclk] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins processing_system7_0/S_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/M01_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_50M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_50M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_50M_peripheral_aresetn [get_bd_pins NN_test_IO_0/rst_n] [get_bd_pins axi_dma_0/axi_resetn] [get_bd_pins axi_mem_intercon/ARESETN] [get_bd_pins axi_mem_intercon/M00_ARESETN] [get_bd_pins axi_mem_intercon/S00_ARESETN] [get_bd_pins axi_mem_intercon/S01_ARESETN] [get_bd_pins myip_v1_0_0/m00_axis_aresetn] [get_bd_pins myip_v1_0_0/reset_n] [get_bd_pins myip_v1_0_0/s00_axi_aresetn] [get_bd_pins myip_v1_0_0/s00_axis_aresetn] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins ps7_0_axi_periph/M00_ARESETN] [get_bd_pins ps7_0_axi_periph/M01_ARESETN] [get_bd_pins ps7_0_axi_periph/S00_ARESETN] [get_bd_pins rst_ps7_0_50M/peripheral_aresetn]
  ...
  assign_bd_address -offset 0x43C00000 -range 0x00010000 -target_address_space [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs myip_v1_0_0/s00_axi/reg0] -force
