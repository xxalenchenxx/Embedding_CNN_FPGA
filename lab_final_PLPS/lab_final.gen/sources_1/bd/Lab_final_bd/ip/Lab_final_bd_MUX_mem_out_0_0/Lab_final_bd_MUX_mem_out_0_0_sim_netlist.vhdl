...
--               c:/Lab_final/lab_final_PLPS/lab_final.gen/sources_1/bd/Lab_final_bd/ip/Lab_final_bd_MUX_mem_out_0_0/Lab_final_bd_MUX_mem_out_0_0_sim_netlist.vhdl
...
entity Lab_final_bd_MUX_mem_out_0_0_MUX_mem_out is
  port (
  ...
  attribute ORIG_REF_NAME of Lab_final_bd_MUX_mem_out_0_0_MUX_mem_out : entity is "MUX_mem_out";
end Lab_final_bd_MUX_mem_out_0_0_MUX_mem_out;

architecture STRUCTURE of Lab_final_bd_MUX_mem_out_0_0_MUX_mem_out is
  ...
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[1]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[2]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[3]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[4]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[5]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  attribute FSM_ENCODED_STATES of \FSM_onehot_cur_state_reg[6]\ : label is "tb:0000001,ConV1:1000000,MP1:0100000,ConV2_ConV3:0010000,MP2:0001000,FC:0000010,idle:0000100";
  ...
  attribute SOFT_HLUTNM of ram_en_w_INST_0_i_1 : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \rom_addr_ri_reg[11]_i_1\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \rom_addr_rw_reg[14]_i_2\ : label is "soft_lutpair1";
  ...
  attribute SOFT_HLUTNM of rom_en_rw_reg_i_1 : label is "soft_lutpair1";
begin
...
\FSM_onehot_cur_state[6]_i_2\: unisim.vcomponents.LUT4
    generic map(
      INIT => X"8F88"
    )
        port map (
...
\ram_addr_ri_reg[0]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[10]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[11]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[12]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[13]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[14]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[15]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[1]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[2]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[3]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[4]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[5]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[6]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[7]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[8]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
\ram_addr_ri_reg[9]_i_2\: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
ram_en_ri_reg_i_2: unisim.vcomponents.LUT5
    generic map(
      INIT => X"FAAAF888"
    )
        port map (
...
entity Lab_final_bd_MUX_mem_out_0_0 is
  ...
  attribute NotValidForBitStream of Lab_final_bd_MUX_mem_out_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of Lab_final_bd_MUX_mem_out_0_0 : entity is "Lab_final_bd_MUX_mem_out_0_0,MUX_mem_out,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of Lab_final_bd_MUX_mem_out_0_0 : entity is "yes";
  attribute IP_DEFINITION_SOURCE : string;
  attribute IP_DEFINITION_SOURCE of Lab_final_bd_MUX_mem_out_0_0 : entity is "module_ref";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of Lab_final_bd_MUX_mem_out_0_0 : entity is "MUX_mem_out,Vivado 2021.2";
end Lab_final_bd_MUX_mem_out_0_0;

architecture STRUCTURE of Lab_final_bd_MUX_mem_out_0_0 is
...
begin
inst: entity work.Lab_final_bd_MUX_mem_out_0_0_MUX_mem_out
     port map (
      clk => clk,
      end_ConV1 => end_ConV1,
      end_ConV3 => end_ConV3,
