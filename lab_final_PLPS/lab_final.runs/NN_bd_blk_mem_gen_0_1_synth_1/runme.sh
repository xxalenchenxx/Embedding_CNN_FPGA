...
HD_PWD='C:/Lab_final/lab_final - test/lab_final.runs/NN_bd_blk_mem_gen_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NN_bd_blk_mem_gen_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NN_bd_blk_mem_gen_0_1.tcl
