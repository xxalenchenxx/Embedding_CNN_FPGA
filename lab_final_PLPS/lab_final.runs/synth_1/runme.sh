...
HD_PWD='C:/Users/Student/Desktop/Lab_final/lab_final_PLPS/lab_final.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_final_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_final_bd_wrapper.tcl
