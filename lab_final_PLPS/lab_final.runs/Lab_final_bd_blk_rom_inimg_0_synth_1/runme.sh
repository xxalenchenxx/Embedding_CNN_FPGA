...
HD_PWD='C:/Lab_final/lab_final_PLPS/lab_final.runs/Lab_final_bd_blk_rom_inimg_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_final_bd_blk_rom_inimg_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab_final_bd_blk_rom_inimg_0.tcl
