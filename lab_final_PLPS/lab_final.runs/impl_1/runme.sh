...
HD_PWD='C:/Lab_final/lab_final_PLPS/lab_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab_final_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab_final_bd_wrapper.tcl -notrace
