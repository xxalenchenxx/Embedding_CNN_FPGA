...
proc init_gui { IPINST } {
  ...
  ipgui::add_param $IPINST -name "flattern" -parent ${Page_0}
...
proc update_PARAM_VALUE.flattern { PARAM_VALUE.flattern } {
	# Procedure called to update flattern when any of the dependent parameters in the arguments change
}

proc validate_PARAM_VALUE.flattern { PARAM_VALUE.flattern } {
	# Procedure called to validate flattern
	return true
}
...
proc update_MODELPARAM_VALUE.flattern { MODELPARAM_VALUE.flattern PARAM_VALUE.flattern } {
	# Procedure called to set VHDL generic/Verilog parameter value(s) based on TCL parameter value
	set_property value [get_property value ${PARAM_VALUE.flattern}] ${MODELPARAM_VALUE.flattern}
}
