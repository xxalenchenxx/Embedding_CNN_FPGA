...
HD_PWD='C:/Lab_final/lab_final _PL/lab_final.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log NN_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source NN_bd_wrapper.tcl -notrace
