...
HD_PWD='C:/Lab_final/lab_final _NN/lab_final.runs/NN_bd_FC_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log NN_bd_FC_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source NN_bd_FC_0_0.tcl
