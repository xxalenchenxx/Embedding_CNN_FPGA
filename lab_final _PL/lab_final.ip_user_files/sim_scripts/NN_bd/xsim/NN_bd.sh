...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L xpm -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L uvm -L unisims_ver -L unimacro_ver -L secureip --snapshot NN_bd xil_defaultlib.NN_bd xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim NN_bd -key {Behavioral:sim_1:Functional:NN_bd} -tclbatch cmd.tcl -log simulate.log
}
