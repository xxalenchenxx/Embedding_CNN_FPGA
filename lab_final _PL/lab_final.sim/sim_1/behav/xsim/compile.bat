...
REM
REM Generated by Vivado on Tue Dec 19 14:44:04 +0800 2023
...
echo "xvlog --incr --relax -prj NN_tb_vlog.prj"
call xvlog  --incr --relax -prj NN_tb_vlog.prj -log xvlog.log
